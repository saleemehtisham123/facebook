...
function show_status($id, $gender, $name, $prf_image)
{
    ...
    $output .= "<div class='w-100 p-2 mt-2 users-profile-link'><a href='other_users_profile.php?id=$id' class='users-id-anchor'>
                    <img src='profile_img/$gender_local' class='profile_img_logo mr-1' alt='Something went wrong'><b>$name </b></a><button class='btn btn-warning added_friend'>Friends</button></div>";
